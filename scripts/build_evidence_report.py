...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the V3.8 data-quality and evidence report.")
    ...
    parser.add_argument("--output", default="artifacts/evidence_report_v3_8.json")
...
def main() -> int:
    ...
    return 0 if report["quality_gate"]["accepted"] else 4
