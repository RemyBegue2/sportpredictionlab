...
def build_release_evidence(root: str | Path, *, version: str = APP_VERSION) -> dict[str, Any]:
    ...
    for relative in (
        ...
        "sports_predictor/roi_lab.py",
        "sports_predictor/challenger_factory.py",
        "sports_predictor/evidence_acceleration.py",
        "sports_predictor/controlled_decision.py",
        "sports_predictor/shadow_mode.py",
        ...
        ".github/workflows/capture-daily-research.yml",
        ".github/workflows/settle-daily-research.yml",
        ".github/workflows/optimise-roi-policy.yml",
        ".github/workflows/automated-shadow-learning.yml",
        ".github/workflows/promote-research-champion.yml",
        ".github/workflows/run-challenger-factory.yml",
        ".github/workflows/run-evidence-acceleration.yml",
        ".github/workflows/run-controlled-model-decision.yml",
        ".github/workflows/verify-long-session.yml",
        "alembic.ini",
        "alembic/env.py",
        "alembic/versions/20260804_0001_existing_schema_baseline.py",
        "alembic/versions/20260804_0002_dataset_catalog_and_holdouts.py",
        ...
        "sports_predictor/evidence_campaign.py",
        "sports_predictor/coverage_preflight.py",
        "sports_predictor/sample_plan.py",
        "scripts/run_coverage_preflight.py",
        "scripts/browser_smoke_test.py",
        "scripts/run_controlled_model_decision.py",
        "scripts/import_tennis_incremental.py",
        ".github/workflows/estimate-evidence-coverage.yml",
