...
WORKFLOW_CATALOG: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "capture-daily-research",
        "name": "Capture daily football and tennis research",
        "file": "capture-daily-research.yml",
        "purpose": "Capturer sous plafond les cotes football et tennis du jour, créer des signaux shadow et mettre à jour les simulations.",
        "risk": "consumes_api_credits",
        "confirmation": "CAPTURE_DAILY_MARKET",
        "required_configuration": [
            "APP_PUBLIC_URL", "APP_PASSWORD", "THE_ODDS_API_KEY",
            "DAILY_ODDS_ENABLED", "DAILY_ODDS_MAX_CREDITS", "SHADOW_MODE_ENABLED",
        ],
    },
    {
        "id": "settle-daily-research",
        "name": "Settle daily football and tennis research",
        "file": "settle-daily-research.yml",
        "purpose": "Importer les résultats terminés sous plafond, régler les signaux shadow et recalculer les bankrolls simulées.",
        "risk": "consumes_api_credits",
        "confirmation": "SETTLE_DAILY_MARKET",
        "required_configuration": ["APP_PUBLIC_URL", "APP_PASSWORD", "THE_ODDS_API_KEY"],
    },
    {
        "id": "optimise-roi-policy",
        "name": "Optimise simulated ROI policy",
        "file": "optimise-roi-policy.yml",
        "purpose": "Optimiser sans appel fournisseur les seuils de sélection sur validation chronologique et holdout.",
        "risk": "zero_credit",
        "confirmation": None,
        "required_configuration": ["APP_PUBLIC_URL", "APP_PASSWORD"],
    },
    ...
    {
        "id": "run-evidence-acceleration",
        "name": "Run evidence acceleration",
        "file": "run-evidence-acceleration.yml",
        "purpose": "Versionner les preuves tennis, expliquer le hold football et sceller une génération de holdout sans fournisseur.",
        "risk": "zero_credit",
        "confirmation": "RUN_EVIDENCE_ACCELERATION",
        "required_configuration": [],
    },
    {
        "id": "verify-long-session",
        "name": "Verify public long session",
        "file": "verify-long-session.yml",
        "purpose": "Tester le cockpit public pendant une session bornée et publier les mesures DOM, réseau et erreurs.",
        "risk": "read_only",
        "confirmation": None,
        "required_configuration": ["APP_PUBLIC_URL", "APP_PASSWORD"],
    },
    ...
    },
    {
        ...
        "required_configuration": ["THE_ODDS_API_KEY", "RAILWAY_TOKEN", "RAILWAY_PROJECT_ID", "APP_PUBLIC_URL"],
    },
    {
        "id": "backup-database",
